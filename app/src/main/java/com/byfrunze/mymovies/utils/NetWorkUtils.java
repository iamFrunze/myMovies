...
public class NetWorkUtils {
    ...
    private static final String API_KEY = "0746af9ef9f4bd6941f3db1094f553ef";
    private static final String BASE_URL = "https://api.themoviedb.org/3/discover/movie";
    private static final String BASE_URL_VIDEOS = "https://api.themoviedb.org/3/movie/%s/videos";
    public static final String BASE_URL_REVIEWS = "https://api.themoviedb.org/3/movie/{movie_id}/reviews";
    ...
    private static URL buldURL(int sortBy, int page) {
        URL result = null;
        String methodOfSort;
